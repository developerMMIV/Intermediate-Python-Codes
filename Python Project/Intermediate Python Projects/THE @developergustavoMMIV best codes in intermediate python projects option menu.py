...
sleep(0.5)
print('Preparing your projects...')
sleep(0.8)
print('Loading code in two sec or less')
sleep(0.9)

print('This is the Game list by @developerMMIV.')
choice = 0

while choice !=6:
    print('''CHOOSE YOUR GAME:
    [ 1 ] The wife Material Test
    [ 2 ] The guess game
    [ 3 ] The data test 
    [ 4 ] The palidrome detector
    ...
    if choice == 1:
        ...
        Answer: '''))
        while question8 !=5 and question8 !=4 and question8 != 3 and question8 != 2 and question8 != 1:
        ...
        [ 4 ] No, No
          Answer:  '''))
        while question10 != 4 and question10 != 3 and question10 != 2 and question10 != 1:
        ...
        if point < 49:
            ...
            print(
                "                  WIFE              {}%          MATERIAL                                          ".format(
                    point))
            print('''{} YOU ARE A WIFE MATERIAL!!!!  your score is {} and that is an A!!
              you belong of the 20% of the women that are conservative with their family, religion and social values in this world  '''.format(
                nome, point))
